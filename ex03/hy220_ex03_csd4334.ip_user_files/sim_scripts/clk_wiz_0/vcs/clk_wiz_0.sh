...
#
# Generated by Vivado on Thu Jul 08 15:20:33 EEST 2021
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../hy220_ex03_csd4334.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../hy220_ex03_csd4334.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/carv/Documents/Vivado_Projects/hy220_ex03_csd4334/hy220_ex03_csd4334.cache/compile_simlib/vcs"
  fi
